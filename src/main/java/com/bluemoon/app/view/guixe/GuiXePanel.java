...
public class GuiXePanel extends JPanel {
    ...
    private List<PhuongTien> currentList;
        ...
        public void initEvent(int row) {
            ...
            btnEdit.addActionListener(e -> {
                if (row >= 0 && row < currentList.size()) {
                    ...
                    PhuongTien selectedPt = currentList.get(row);
            ...
            btnDelete.addActionListener(e -> {
                if (row >= 0 && row < currentList.size()) {
                    ...
                    int confirm = JOptionPane.showConfirmDialog(GuiXePanel.this,
                            "Bạn có chắc chắn muốn hủy gửi xe biển số: " + selectedPt.getBienSo() + "?",
                            "Xác nhận hủy gửi", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                            
                    if (confirm == JOptionPane.YES_OPTION) {
                        boolean deleted = controller.deletePhuongTien(selectedPt.getBienSo());
                        if (deleted) {
