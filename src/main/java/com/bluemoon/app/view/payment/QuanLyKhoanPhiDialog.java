...
public class QuanLyKhoanPhiDialog extends JDialog {
    ...
    private Fee currentKhoanPhi = null;
    ...
    public void setEditData(Fee kp) {
        this.isEditMode = true;
        this.currentKhoanPhi = kp;
        lblTitle.setText("CẬP NHẬT KHOẢN THU");
        btnSave.setText("Lưu thay đổi");
        txtTenKhoan.setText(kp.getName());
        txtDonGia.setText(String.valueOf(kp.getUnitPrice()));
        cbDonVi.setSelectedItem(kp.getUnit());
        cbLoaiPhi.setSelectedIndex(kp.getType() == AppConstants.PHI_BAT_BUOC ? 0 : 1);
        updateDonGiaVisibility();
    }
