...
public class CongNoDAO {
     ...
     */
    public List<Invoice> getAll(int thang, int nam) throws SQLException {
     ...
     * @throws SQLException lỗi kết nối CSDL
     */
    public List<Invoice> getAll(int thang, int nam, String keyword) throws SQLException {
        ...
        try (Connection conn = DatabaseConnector.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    cn.setYear(rs.getInt("Nam"));
                    cn.setAmountDue(rs.getDouble("SoTienPhaiDong"));
                    cn.setAmountPaid(rs.getDouble("SoTienDaDong"));
                    cn.setStatus(rs.getInt("TrangThai"));
                    list.add(cn);
                }
            }
